...
function getAllHtmlFiles(dir) {
  ...
  for (const e of entries) {
    if (e.isDirectory()) {
      ...
      if (["img", "css", "js", "plugins", "scss", "scripts"].includes(e.name))
        continue;
...
const projectsBlockRegex =
  /<h6 class="mil-muted mil-mb-30">Projects<\/h6>\s*<ul class="mil-menu-list">[\s\S]*?<\/ul>/g;
