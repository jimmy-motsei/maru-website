  ...
  if (variant === "overlay") {
    ...
    return (
      <div className={cn("absolute inset-0 pointer-events-none overflow-hidden select-none", className)}>
        <div className="absolute top-[-20%] right-[-10%] scale-[0.8] origin-top-right opacity-30">
  ...
  return (
    <div className={cn("absolute inset-0 pointer-events-none overflow-hidden select-none", className)}>
      ...
      <div className="absolute inset-0 z-20">
         <div className="absolute top-[10%] left-[5%] opacity-[0.4]">
            <CloudWireframe 
         ...
         <div className="absolute bottom-[20%] right-[15%] opacity-[0.4]">
            <CloudWireframe 
          ...
          <div className="absolute top-[50%] left-[-10%] opacity-[0.4]">
            <CloudWireframe 
