...
const newsItems = [
  {
    ...
    excerpt: "58% of SMBs now use generative AI—up from 40% in 2024. With 91% reporting revenue increases and 20+ hours saved monthly, the competitive advantage has never been clearer.",
