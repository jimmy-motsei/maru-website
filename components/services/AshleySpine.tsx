  ...
  return (
    <div className="pointer-events-none select-none">
      <svg
        ...
        className="w-[250px] max-w-full h-auto opacity-20"
        aria-hidden="true"
      >
        <path
          fillRule="evenodd"
        ...
        <path
          ...
          className="ashley-spine-move"
        />
        <path fillRule="evenodd" clipRule="evenodd" d="M300 1175H0V1174H300V1175Z" className="ashley-spine-move" />
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          ...
          className="ashley-spine-move"
        />
        <path fillRule="evenodd" clipRule="evenodd" d="M299 380H1V678H299V380ZM0 379V679H300V379H0Z" className="ashley-spine-move" />
      </svg>
      ...
      <style jsx>{`
        ...
        .ashley-spine-move {
          animation: ashley-spine-move 10s linear infinite;
          will-change: transform;
        }

        @keyframes ashley-spine-move {
          from {
