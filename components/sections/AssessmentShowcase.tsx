      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-20">
        ...
        >
          ...
          <div className="mb-8">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Discover Your <span>Lead Generation Potential</span>
            </h2>
        ...
        <div className="max-w-2xl mx-auto mb-12">
          <motion.div
            ...
            className="relative"
          >
            <div className="absolute -top-3 left-6 bg-gradient-to-r from-highlight to-highlight-hover text-black px-3 py-1 rounded-full text-xs font-semibold z-10">
              FEATURED TOOL
            </div>
            <a
              href="https://leads.maruonline.com"
              target="_blank"
              rel="noopener noreferrer"
              className="group block p-8 bg-zinc-900 border border-highlight/20 hover:border-highlight/50 rounded-2xl transition-all duration-300 hover:transform hover:scale-[1.02] ring-2 ring-highlight/30"
            >
              <div className="flex items-start gap-6">
                <div className="p-4 bg-highlight/10 rounded-xl">
                  <Target className="w-8 h-8 text-highlight" />
                </div>
                
                <div className="flex-1">
                  <div className="flex items-center justify-between mb-3">
                    <h3 className="text-xl font-semibold text-white group-hover:text-highlight transition-colors">
                      Website Lead Grader™
                    </h3>
                    <ArrowRight className="w-5 h-5 text-zinc-400 group-hover:text-highlight group-hover:translate-x-1 transition-all" />
                  </div>
                  ...
                  <div className="mt-4 flex items-center gap-2">
                    ...
                    <div className="flex-1 bg-zinc-800 rounded-full h-1.5">
                      <div className="h-1.5 rounded-full bg-highlight" style={{ width: '92%' }}></div>
                    </div>
