...
export function ServiceCard({ title, description, href }: ServiceCardProps) {
  return (
    <Link href={href} className="group block h-full p-8 transition-[transform,box-shadow,background-color] duration-300 ease-out hover:bg-card-dark hover:-translate-y-1 hover:shadow-[0_8px_24px_rgba(0,0,0,0.15)]">
