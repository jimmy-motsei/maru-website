...
const forms = [
  {
    ...
    icon: <Bot size={24} />,
    color: "var(--color-cyan-primary)", // Cyan
  },
  {
            ...
            <Link key={form.href} href={form.href} className="group h-full">
              <FeatureCard className="h-full bg-black/40 backdrop-blur-md" glowOnHover>
                <div className="flex flex-col h-full">
                  ...
                  <h3 className="mb-3 text-2xl font-bold text-white group-hover:text-[var(--color-cyan-primary)] transition-colors">
                    {form.title}
                  </h3>
                  ...
                  <div className="flex items-center text-sm font-bold uppercase tracking-widest text-[var(--color-cyan-primary)]">
                    Start Brief
