...
export const metadata: Metadata = {
  title: 'assessment tools | Knowledge Base',
  description: 'Browse articles in assessment tools',
};

export default function CategoryPage() {
  return (
    <div className="container mx-auto px-4 py-12 max-w-4xl text-white">
      <h1 className="text-4xl font-bold mb-8 capitalize">assessment tools</h1>
