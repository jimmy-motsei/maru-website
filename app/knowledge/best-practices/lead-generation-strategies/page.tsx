...
export const metadata: Metadata = {
  title: 'lead generation strategies | Maru Knowledge',
  description: 'Detailed guide on lead generation strategies.',
};

export default function ArticlePage() {
  return (
    <div className="container mx-auto px-4 py-12 max-w-3xl text-white">
      <h1 className="text-4xl font-bold mb-6 capitalize">lead generation strategies</h1>
