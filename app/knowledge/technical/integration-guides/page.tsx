...
export const metadata: Metadata = {
  title: 'integration guides | Maru Knowledge',
  description: 'Detailed guide on integration guides.',
};

export default function ArticlePage() {
  return (
    <div className="container mx-auto px-4 py-12 max-w-3xl text-white">
      <h1 className="text-4xl font-bold mb-6 capitalize">integration guides</h1>
