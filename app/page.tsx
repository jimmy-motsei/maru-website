    ...
    <>
      ...
      >
        <div className={innerNarrow}>
          <FadeUp><h2>The problem</h2></FadeUp>
      ...
      >
        <div className={innerNarrow}>
          <FadeUp><h2>We start with what you have — not what we want to sell you</h2></FadeUp>
          <FadeUp delay={0.08}>
            <p className="body-muted" style={{ marginBottom: "var(--space-para-section)" }}>
      ...
      >
        <div className={inner}>
          <FadeUp><h2>This is built for businesses like yours if —</h2></FadeUp>
          <FadeUp delay={0.08}>
            <ListGroup>
              <ListItem
