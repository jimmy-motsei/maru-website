          ...
          <div className="grid md:grid-cols-3 gap-4">
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-3 bg-zinc-800 border border-zinc-700 rounded-lg text-white focus:border-cyan focus:outline-none"
              >
          ...
          <div className="flex gap-4 mb-6">
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 bg-zinc-800 border border-zinc-700 rounded-lg text-white focus:border-cyan focus:outline-none"
              />
            </div>
            <select
              value={selectedCategory}
              onChange={(e) => setSelectedCategory(e.target.value)}
              className="px-4 py-3 bg-zinc-800 border border-zinc-700 rounded-lg text-white focus:border-cyan focus:outline-none"
            >
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6 mb-8">
          <div className="max-w-md">
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-zinc-800 border border-zinc-700 rounded-lg text-white focus:border-cyan focus:outline-none mb-4"
              placeholder="your@email.com"
            />
            <button
              onClick={handleSubmit}
              disabled={selectedTools.length === 0 || !email}
              className="w-full px-6 py-3 bg-cyan text-black font-medium rounded-lg hover:bg-cyan-dark disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
              Analyze Tech Stack
            </button>
          </div>
...
function TechAuditResults({ results }: { results: TechAuditResult }) {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Next Steps */}
      <div className="p-6 bg-gradient-to-r from-cyan/20 to-cyan/5 border border-cyan/30 rounded-xl">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <button className="px-6 py-3 bg-cyan text-black font-medium rounded-lg hover:bg-cyan-dark transition-colors">
