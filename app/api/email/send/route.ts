  ...
  assessment_complete: {
    ...
    html: (data: any) => `
      ...
      <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
        <div style="background: linear-gradient(135deg, #3DD6D0 0%, #3b82f6 100%); padding: 30px; text-align: center; border-radius: 10px 10px 0 0;">
        ...
        <div style="background: #f8f9fa; padding: 30px; border-radius: 0 0 10px 10px;">
          ...
          <div style="background: white; padding: 20px; border-radius: 8px; margin: 20px 0; border-left: 4px solid #3DD6D0;">
            <h3 style="color: #3DD6D0; margin-top: 0;">Key Highlights:</h3>
            ${getAssessmentHighlights(data)}
          </div>
          
          <div style="text-align: center; margin: 30px 0;">
            <a href="${process.env.NEXT_PUBLIC_SITE_URL}/contact" 
               style="background: #3DD6D0; color: white; padding: 15px 30px; text-decoration: none; border-radius: 25px; font-weight: bold; display: inline-block;">
          ...
          <div style="text-align: center; color: #666; font-size: 14px;">
            ...
            <a href="mailto:hello@maruonline.com" style="color: #3DD6D0;">hello@maruonline.com</a></p>
          </div>
        </div>
      </body>
      </html>
    ...
    html: (data: any) => `
      ...
      <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
        <div style="background: #f8f9fa; padding: 30px; border-radius: 10px;">
          <h2 style="color: #3DD6D0;">Ready to take action on your assessment results?</h2>
...
function getAssessmentHighlights(data: any): string {
  switch (data.assessmentType) {
    case 'lead_score':
      return `
        <p><strong>Your Website Grade:</strong> ${data.assessmentData?.score || 0}/100</p>
