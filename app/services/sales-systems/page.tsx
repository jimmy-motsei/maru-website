...
const breadcrumbs = [
  ...
  { label: "Service", href: "/services/sales-systems" },
];
...
const accordionItems = [
  {
    ...
    content:
      "We map your current funnel and isolate where qualified prospects stall, drop off, or go silent so your team can fix the right bottlenecks first.",
    features: [
      "Stage-by-stage conversion analysis",
      "Drop-off root-cause breakdown",
      "Priority leak remediation plan",
    ],
  },
  {
    title: "Workflow Automation Design",
    content:
      "Manual sales admin is replaced with reliable automations for follow-up, routing, and updates so reps spend more time closing.",
    features: [
      "Lead assignment and routing",
      "Automated follow-up sequences",
      "CRM update and task automation",
    ],
  },
  {
    title: "CRM and Toolchain Integration",
    content:
      "We integrate your sales and marketing tools so data flows cleanly across handoffs, outreach, and pipeline reporting.",
    features: [
      "Cross-platform data sync",
      "Contact and deal consistency rules",
      "System-to-system handoff logic",
    ],
  },
  {
    title: "Sales Enablement and Adoption",
    content:
      "Your team gets practical onboarding and playbooks to adopt the optimized process quickly and execute it consistently.",
    features: [
  ...
  },
  {
    ...
    content:
      "We monitor conversion performance and continuously tune your sales process as your pipeline, team, and targets evolve.",
    features: [
      "Pipeline KPI dashboarding",
            ...
            <div className="lg:col-span-4">
              <motion.div initial={{ opacity: 0, y: 18 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.25 }} transition={{ duration: 0.45 }}>
                ...
                <Link href="/assessments/pipeline-leak" className="btn-primary-hero-cta group">
                  Start with a Pipeline Diagnostic
